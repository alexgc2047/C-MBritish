  ...
  class bm_shopping_cart {
    ...
    function execute() {
      ...
      if ($cart->count_contents() > 0) {
        $cart_contents_string = '<table border="0" width="100%" cellspacing="0" cellpadding="0" class="ui-widget-content ui-corner-bottom infoBoxContents">';
        ...
        $cart_contents_string .= '<div class="ui-widget-content ui-corner-bottom infoBoxContents">' . MODULE_BOXES_SHOPPING_CART_BOX_CART_EMPTY . '</div>';
      }

      $data = '<div class="ui-widget infoBoxContainer">' .
              '  <div class="ui-widget-header ui-corner-top infoBoxHeading"><a href="' . tep_href_link(FILENAME_SHOPPING_CART) . '">' . MODULE_BOXES_SHOPPING_CART_BOX_TITLE . '</a></div>' .
              '  ' . $cart_contents_string .
              '</div>';
