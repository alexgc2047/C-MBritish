...
define('HEADER_TITLE_LANGUAGE_HEADER', 'Idioma:');
define('HEADER_TITLE_CURRENCY_HEADER', 'Moneda:');
define('HEADER_TITLE_HOME', 'Inicio');
define('HEADER_TITLE_PRODUCTS_NEW', 'Productos Nuevos');
define('HEADER_TITLE_PRODUCTS_SPECIALS', 'Especiales');
define('HEADER_TITLE_PRODUCTS_REVIEWS', 'Reseñas');
define('HEADER_TITLE_CONTACT_US', 'Contactanos');
define('HEADER_TITLE_SEARCH_BOX_TITLE', 'Búsqueda');
define('HEADER_TITLE_ADVANCED_SEARCH', 'Búsqueda Avanzada');
...
define('TEXT_GREETING_PERSONAL_CUSTOMER', 'Bienvenido de Nuevo!, <span class="greetUserheader">%s!</span>&nbsp;<span class="arrowBulletLogin">' . tep_image(DIR_WS_IMAGES . 'arrow.png', 'logoff') . '</span><a href="%s">Logoff</a>');
define('TEXT_GREETING_GUEST_CUSTOMER', '<span class="arrowBulletLogin">' . tep_image(DIR_WS_IMAGES . 'arrow.png', 'Iniciar Sesión') . '</span><a href="%s">Iniciar Sesión</a>&nbsp;&nbsp;&nbsp;<span class="arrowBulletLogin">' . tep_image(DIR_WS_IMAGES . 'arrow.png', 'Crear Cuenta') . '</span><a href="%s">Crear Cuenta</a>');
