...
<h1 class="headingaccountnewsletter"><?php echo HEADING_TITLE; ?></h1>
...
<div class="contentContainer">
	<h2><?php echo MY_NEWSLETTERS_TITLE; ?></h2><hr>

	<div class="contentText">
    
      
        <div id="account-newsletter"><?php echo tep_draw_checkbox_field('newsletter_general', '1', (($newsletter['customers_newsletter'] == '1') ? true : false), 'onclick="checkBox(\'newsletter_general\')"'); ?></div>
        <div><strong><?php echo MY_NEWSLETTERS_GENERAL_NEWSLETTER; ?></strong><br /><?php echo MY_NEWSLETTERS_GENERAL_NEWSLETTER_DESCRIPTION; ?></div>
