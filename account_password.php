...
<h1 class="headingaccountpassword"><?php echo HEADING_TITLE; ?></h1>
...
<div class="contentContainer">
	<div>
		...
		<h2><?php echo MY_PASSWORD_TITLE; ?></h2><hr>
	</div>

	<div id="account-password-container" class="contentText">
    
      
        <div class="fieldKey"><?php echo ENTRY_PASSWORD_CURRENT; ?></div>
        <div class="fieldValue"><?php echo tep_draw_password_field('password_current') . '&nbsp;' . (tep_not_null(ENTRY_PASSWORD_CURRENT_TEXT) ? '<span class="inputRequirement">' . ENTRY_PASSWORD_CURRENT_TEXT . '</span>': ''); ?></div>
      
     
        <div class="fieldKey"><?php echo ENTRY_PASSWORD_NEW; ?></div>
        <div class="fieldValue"><?php echo tep_draw_password_field('password_new') . '&nbsp;' . (tep_not_null(ENTRY_PASSWORD_NEW_TEXT) ? '<span class="inputRequirement">' . ENTRY_PASSWORD_NEW_TEXT . '</span>': ''); ?></div>
      
     
        <div class="fieldKey"><?php echo ENTRY_PASSWORD_CONFIRMATION; ?></div>
        <div class="fieldValue" ><?php echo tep_draw_password_field('password_confirmation') . '&nbsp;' . (tep_not_null(ENTRY_PASSWORD_CONFIRMATION_TEXT) ? '<span class="inputRequirement">' . ENTRY_PASSWORD_CONFIRMATION_TEXT . '</span>': ''); ?></div>
      
    
	</div>
<div id="border-bottom"></div><br />
	<div class="buttonSet">
		<span class="buttonAction"><?php echo tep_draw_button(IMAGE_BUTTON_CONTINUE, 'triangle-1-e', null, 'primary'); ?></span><?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w', tep_href_link(FILENAME_ACCOUNT, '', 'SSL')); ?>
	</div>
</div>
